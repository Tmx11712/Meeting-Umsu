    ...
    if (!minutes) {
        return (
            <div className="flex flex-col gap-6 p-8 max-w-[1400px] mx-auto w-full bg-[#f8fafc]">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <div className="text-sm text-slate-500 flex items-center gap-2">
                            ...
                            <span>›</span>
                            <span className="text-slate-900">Review Notulen</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="text-center py-20 text-slate-500 bg-white rounded-xl shadow-sm border border-slate-200 flex flex-col items-center justify-center">
                    <div className="w-16 h-16 bg-blue-50 text-blue-500 rounded-full flex items-center justify-center mb-4">
                        <Lightbulb className="w-8 h-8" />
                    </div>
                    <h3 className="text-lg font-bold text-slate-900 mb-2">Notulen Belum Digenerate</h3>
